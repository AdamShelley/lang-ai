...
const styles = StyleSheet.create({
  ...
  imageContainer: (wide) => ({
    ...
    minWidth: 10,
    height: wide ? "100%" : "65%",
    borderTopRightRadius: wide ? 0 : 15,
    borderTopLeftRadius: 15,
    borderBottomLeftRadius: wide ? 0 : 15,
    borderBottomRightRadius: wide ? 0 : 15,
    overflow: "hidden",
    position: "relative",
  }),
  ...
  image: (wide) => ({
    ...
    borderTopRightRadius: wide ? 0 : 15,
    borderTopLeftRadius: 15,
    borderBottomLeftRadius: wide ? 15 : 0,
    resizeMode: "cover",
  }),
  overlay: {
  ...
  text: (wide) => ({
    ...
    fontSize: 16,
    fontWeight: 400,
    paddingHorizontal: wide ? 0 : 5,
    marginHorizontal: wide ? 0 : 5,
